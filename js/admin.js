...
import { supabase } from './supabase.js?v20260911-1530-fixed';
import { formatPrice, slugify, REQUIRED_PHONE, REQUIRED_PHONE2, REQUIRED_WHATSAPP, HOMEPAGE_COVERAGE, REQUIRED_MISSION, REQUIRED_VISION, REQUIRED_VALUES } from './data.js?v20260911-1530-fixed';
import { ADMIN_EMAIL } from './config.js?v20260911-1530-fixed';
